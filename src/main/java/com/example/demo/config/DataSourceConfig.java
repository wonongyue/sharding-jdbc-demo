...
public class DataSourceConfig {
    ...
    public ShardingRule shardingRule(DataSourceRule dataSourceRule){
        // 按月动态分表
        TableRule orderTableRule = TableRule.builder("user_info").
                tableShardingStrategy(new TableShardingStrategy("sys_time",
                        new SingleKeyDynamicModuloTableShardingAlgorithm("user_info_"))).
